...
/*Manuscript*/
INSERT INTO Manuscript (Title,DateReceived,`Status`,RICode,PrimaryAuthorId,EditorId,PagesOccupied,StartingPage,`Order`,Document,JournalIssueYear,JournalIssuePeriod) VALUES ("lectus pede, ultrices","2017-01-20 22:43:25","Published",1,15,26,4,5,2,"",2016,'1');
INSERT INTO Manuscript (Title,DateReceived,`Status`,RICode,PrimaryAuthorId,EditorId,PagesOccupied,StartingPage,`Order`,Document,JournalIssueYear,JournalIssuePeriod) VALUES ("eu neque pellentesque","2017-01-26 04:23:12","Typeset",2,84,99,NULL,NULL,NULL,"",NULL,NULL);
INSERT INTO Manuscript (Title,DateReceived,`Status`,RICode,PrimaryAuthorId,EditorId,PagesOccupied,StartingPage,`Order`,Document,JournalIssueYear,JournalIssuePeriod) VALUES ("Phasellus","2016-09-30 12:39:15","Rejected",3,49,44,NULL,NULL,NULL,"",NULL,NULL);
INSERT INTO Manuscript (Title,DateReceived,`Status`,RICode,PrimaryAuthorId,EditorId,PagesOccupied,StartingPage,`Order`,Document,JournalIssueYear,JournalIssuePeriod) VALUES ("Cras","2016-12-31 06:33:53","Under Review",4,31,92,NULL,NULL,NULL,"",NULL,NULL);
INSERT INTO Manuscript (Title,DateReceived,`Status`,RICode,PrimaryAuthorId,EditorId,PagesOccupied,StartingPage,`Order`,Document,JournalIssueYear,JournalIssuePeriod) VALUES ("Cum sociis natoque","2017-09-14 14:36:05","Under Review",5,81,35,12,56,4,"",NULL, NULL);
INSERT INTO Manuscript (Title,DateReceived,`Status`,RICode,PrimaryAuthorId,EditorId,PagesOccupied,StartingPage,`Order`,Document,JournalIssueYear,JournalIssuePeriod) VALUES ("eu","2016-11-13 15:03:22","Received",6,19,41,NULL,NULL,NULL,"",NULL,NULL);
INSERT INTO Manuscript (Title,DateReceived,`Status`,RICode,PrimaryAuthorId,EditorId,PagesOccupied,StartingPage,`Order`,Document,JournalIssueYear,JournalIssuePeriod) VALUES ("facilisis","2016-07-31 22:12:15","Received",7,68,100,NULL,NULL,NULL,"",NULL,NULL);
INSERT INTO Manuscript (Title,DateReceived,`Status`,RICode,PrimaryAuthorId,EditorId,PagesOccupied,StartingPage,`Order`,Document,JournalIssueYear,JournalIssuePeriod) VALUES ("adipiscing lobortis risus.","2016-11-14 14:30:49","Under Review",7,91,87,NULL,NULL,NULL,"",NULL,NULL);
INSERT INTO Manuscript (Title,DateReceived,`Status`,RICode,PrimaryAuthorId,EditorId,PagesOccupied,StartingPage,`Order`,Document,JournalIssueYear,JournalIssuePeriod) VALUES ("dolor.","2017-07-24 20:03:02","Received",8,76,94,NULL,NULL,NULL,"",NULL,NULL);
INSERT INTO Manuscript (Title,DateReceived,`Status`,RICode,PrimaryAuthorId,EditorId,PagesOccupied,StartingPage,`Order`,Document,JournalIssueYear,JournalIssuePeriod) VALUES ("augue malesuada","2016-11-02 18:15:49","Received",9,7,24,NULL,NULL,NULL,"",NULL,NULL);
INSERT INTO Manuscript (Title,DateReceived,`Status`,RICode,PrimaryAuthorId,EditorId,PagesOccupied,StartingPage,`Order`,Document,JournalIssueYear,JournalIssuePeriod) VALUES ("libero. Donec consectetuer","2018-01-27 23:21:23","Received",10,2,98,NULL,NULL,NULL,"",NULL,NULL);
INSERT INTO Manuscript (Title,DateReceived,`Status`,RICode,PrimaryAuthorId,EditorId,PagesOccupied,StartingPage,`Order`,Document,JournalIssueYear,JournalIssuePeriod) VALUES ("lorem, auctor","2017-10-01 23:25:06","Received",10,51,5,NULL,NULL,NULL,"",NULL,NULL);
INSERT INTO Manuscript (Title,DateReceived,`Status`,RICode,PrimaryAuthorId,EditorId,PagesOccupied,StartingPage,`Order`,Document,JournalIssueYear,JournalIssuePeriod) VALUES ("Etiam","2016-11-27 13:35:56","Received",10,55,20,NULL,NULL,NULL,"",NULL,NULL);
INSERT INTO Manuscript (Title,DateReceived,`Status`,RICode,PrimaryAuthorId,EditorId,PagesOccupied,StartingPage,`Order`,Document,JournalIssueYear,JournalIssuePeriod) VALUES ("vulputate,","2016-08-30 02:48:36","Received",10,39,19,NULL,NULL,NULL,"",NULL,NULL);
INSERT INTO Manuscript (Title,DateReceived,`Status`,RICode,PrimaryAuthorId,EditorId,PagesOccupied,StartingPage,`Order`,Document,JournalIssueYear,JournalIssuePeriod) VALUES ("euismod mauris","2018-04-09 06:25:01","Received",10,29,10,NULL,NULL,NULL,"",NULL,NULL);
INSERT INTO Manuscript (Title,DateReceived,`Status`,RICode,PrimaryAuthorId,EditorId,PagesOccupied,StartingPage,`Order`,Document,JournalIssueYear,JournalIssuePeriod) VALUES ("consectetuer ipsum","2017-08-07 10:09:32","Received",10,55,81,NULL,NULL,NULL,"",NULL,NULL);
